...
export interface VideoEntryItem {
  id: string;
  path: string;
  filename: string;
  title: string;
...
export interface SiteData {
  ...
  videos: VideoEntryItem[];
  awards: AwardPhotoItem[];
...
export function useSiteData(): [SiteData, (updater: SiteData | ((prev: SiteData) => SiteData)) => void] {
  ...
  const updateData = (updater: SiteData | ((prev: SiteData) => SiteData)) => {
